...
ev("(list :dbgauthstatus (dbgauth) :mdcr-el2 (mdcr2))",10.0)
ev("(list :linux-order (inst-linux-order) :typer0 (typer0) :enset (enset) :cntr0-before (cntr0) :after-addloop (progn (addloop 100000) (cntr0)) :mdcr-el2 (mdcr2))",60.0)
print("=== PMU5 DONE ===",flush=True)
