...
ev("(list :ceid0 (ceid0) :ceid1 (ceid1))",10.0)
ev("(list :event 8 (evt-08) :before (cntr0) :after-addloop (progn (addloop 100000) (cntr0)))",60.0)
ev("(list :event 27 (evt-1b) :before (cntr0) :after-addloop (progn (addloop 100000) (cntr0)))",60.0)
ev("(list :event 4 (evt-04) :before (cntr0) :after-addloop (progn (addloop 100000) (cntr0)))",60.0)
ev("(list :event 17 (evt-11) :before (cntr0) :after-addloop (progn (addloop 100000) (cntr0)))",60.0)
ev("(list :event 16 (evt-10) :before (cntr0) :after-addloop (progn (addloop 100000) (cntr0)))",60.0)
ev("(list :event 3 (evt-03) :before (cntr0) :after-addloop (progn (addloop 100000) (cntr0)))",60.0)
ev("(list :event 0 (evt-00) :before (cntr0) :after-addloop (progn (addloop 100000) (cntr0)))",60.0)
print("=== PMU6 DONE ===",flush=True)
