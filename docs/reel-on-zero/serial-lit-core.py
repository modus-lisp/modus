...
ev("(list :root-before (mem-ref 268439312 :u64) (mem-ref 268439064 :u64))")
...
ev("(jit-eager)",2400.0)
ev("(list :root-after (mem-ref 268439312 :u64))")
raw("(defun words2 (a) (list #xC0C0C0C0 (logior #xC0000000 a) #xC0C0C0C0 #xFF000000 #x80000000 a))",4.0)
ev("(words2 340025376)",30.0)
ev("(words 0 60 1920 1080 320 180 340025376 340114448 340139024 384 192 2100)",60.0)
