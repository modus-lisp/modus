...
ev("(list :displist (hvs-displist) :active (hvs-active-channel) :plane *rh-plane* :kslot *hvs-kernel-slot*)",30.0)
...
ev("(let* ((b (first *rh-bufs*)) (y (reel.decode::picture-y *pic*)) (r nil)) (dolist (row (list 0 32 100 200)) (let ((o (* row 384))) (push (list row (mem-ref (+ b o 40) :u8) (aref y (+ o 40))) r))) (reverse r))",60.0)
ev("(let ((fw (hvs-rd (+ (hvs-base) 52)))) (list :fw fw (hvs-rd (+ (hvs-base) 8192 (* fw 4))) (hvs-rd (+ (hvs-base) 8192 (* (+ fw 1) 4)))))",30.0)
