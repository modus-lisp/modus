...
ev("(if (fboundp (quote %net-fnv1a)) 1 0)")
ev("(%net-fnv1a *rh-ivf* 4096)",120.0)
ev("(%net-fnv1a *rh-ivf* 65536)",300.0)
ev("(%net-fnv1a *rh-ivf* 151295)",600.0)
print("--- serial tail after full run ---"); print(rd_until(r"never",3.0)[-300:])
