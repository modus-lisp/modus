...
# Drain anything still streaming (a bare (in-package X) prints the WHOLE package object), then reset the package.
rd_until(r"never",3.0)
...
# Every form is fully qualified and ACKNOWLEDGED (tagged ev), never sent blind.
...
ev("(progn (setq reel.decode::*t-residue* 0) (setq reel.decode::*t-luma16* 0) (setq reel.decode::*t-bpred* 0) (setq reel.decode::*t-chroma* 0) (setq reel.decode::*t-interpred* 0) (setq reel.decode::*t-interres* 0) (setq reel.decode::*t-mbmodes* 0) (setq reel.decode::*t-intermodes* 0) (setq reel.decode::*t-intramodes* 0) (setq reel.decode::*t-lfparams* 0) (setq reel.decode::*t-loopf* 0) (setq reel.decode::*t-refcopy* 0) (setq reel.decode::*t-mbloop* 0) :reset)",30.0)
ev("(reel-demo-pass 4)",900.0)
ev("(list (list :residue (round reel.decode::*t-residue* (* 90 (floor (cntfrq) 1000)))) (list :luma16 (round reel.decode::*t-luma16* (* 90 (floor (cntfrq) 1000)))) (list :bpred (round reel.decode::*t-bpred* (* 90 (floor (cntfrq) 1000)))) (list :chroma (round reel.decode::*t-chroma* (* 90 (floor (cntfrq) 1000)))) (list :interpred (round reel.decode::*t-interpred* (* 90 (floor (cntfrq) 1000)))) (list :interres (round reel.decode::*t-interres* (* 90 (floor (cntfrq) 1000)))) (list :mbmodes (round reel.decode::*t-mbmodes* (* 90 (floor (cntfrq) 1000)))) (list :intermodes (round reel.decode::*t-intermodes* (* 90 (floor (cntfrq) 1000)))) (list :intramodes (round reel.decode::*t-intramodes* (* 90 (floor (cntfrq) 1000)))) (list :lfparams (round reel.decode::*t-lfparams* (* 90 (floor (cntfrq) 1000)))) (list :loopf (round reel.decode::*t-loopf* (* 90 (floor (cntfrq) 1000)))) (list :refcopy (round reel.decode::*t-refcopy* (* 90 (floor (cntfrq) 1000)))) (list :mbloop (round reel.decode::*t-mbloop* (* 90 (floor (cntfrq) 1000)))))",60.0)
