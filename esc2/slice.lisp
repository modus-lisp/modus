  ...
  (defun sharpL-reader (stream subchar n-args)
    ...
    (let* ((form (read stream t nil t))
	   (refd-!vars (sort (bang-vars (macroexpand form))
                             #'< :key #'bang-var-num))
	   (dbg1 (progn (princ "  DBG fnobj=") (princ (function bang-var-num)) (princ " int=") (princ (integerp (function bang-var-num))) (princ " val=") (princ (if (integerp (function bang-var-num)) (function bang-var-num) :na)) (princ " fnp=") (princ (functionp (function bang-var-num))) (princ " glob=") (princ (symbol-function 'bang-var-num)) (terpri) (finish-output)))
