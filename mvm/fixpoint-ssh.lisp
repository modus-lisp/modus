...
(defun init-arch-addrs ()
  (let ((arch (td-read-u32 #x2000008)))
    (cond
      ((= arch 0) ;; x64
       (td-write-u32 #x2000040 #x05060000)
       (td-write-u32 #x2000044 #x05080000)
       (td-write-u32 #x2000048 #x04000000)  ;; ssh-ipc (was 0x300000 — now inside the ~15 MB image)
       (td-write-u32 #x200004C #x05000000)
       (td-write-u32 #x2000050 #x05001000)
       (td-write-u32 #x2000054 #x05041000)
       (td-write-u32 #x2000058 #x05041400)
       (td-write-u32 #x200005C 0)        ;; pci-mode=0 (port I/O)
       (td-write-u32 #x2000060 #x05090000)
       (td-write-u32 #x2000064 #x05000000)
       (td-write-u32 #x2000068 0))
      ((= arch 1) ;; aarch64
       (td-write-u32 #x2000040 #x41060000)
       (td-write-u32 #x2000044 #x41080000)
       (td-write-u32 #x2000048 #x41100000)
       (td-write-u32 #x200004C #x41000000)
       (td-write-u32 #x2000050 #x41001000)
       (td-write-u32 #x2000054 #x41041000)
       (td-write-u32 #x2000058 #x41041400)
       (td-write-u32 #x200005C 1)        ;; pci-mode=1 (ECAM)
       (td-write-u32 #x2000060 #x41090000)
       (td-write-u32 #x2000064 #x41000000)
       (td-write-u32 #x2000068 0))
      ((= arch 2) ;; i386
       ...
       (td-write-u32 #x2000040 #x2000000)   ;; state-base (was 0x200000)
       (td-write-u32 #x2000044 #x580000)   ;; ssh-conn (was 0x280000)
       (td-write-u32 #x2000048 #x600000)   ;; ssh-ipc (was 0x300000)
       (td-write-u32 #x200004C #x490000)   ;; rx-desc (was 0x180000)
       (td-write-u32 #x2000050 #x491000)   ;; rx-buf (was 0x181000)
       (td-write-u32 #x2000054 #x4D1000)   ;; tx-desc (was 0x1C1000)
       (td-write-u32 #x2000058 #x4D1400)   ;; tx-buf (was 0x1C1400)
       (td-write-u32 #x200005C 2)           ;; pci-mode=2 (none)
       (td-write-u32 #x2000060 #x690000)   ;; usb-ring (was 0x290000)
       (td-write-u32 #x2000064 #x490000)   ;; usb-dma (was 0x180000)
       (td-write-u32 #x2000068 0))
      ((= arch 3) ;; arm32
       (td-write-u32 #x2000040 #x01060000)
       (td-write-u32 #x2000044 #x01080000)
       (td-write-u32 #x2000048 #x01100000)
       (td-write-u32 #x200004C #x01000000)
       (td-write-u32 #x2000050 #x01001000)
       (td-write-u32 #x2000054 #x01041000)
       (td-write-u32 #x2000058 #x01041400)
       (td-write-u32 #x200005C 2)        ;; pci-mode=2 (none)
       (td-write-u32 #x2000060 #x01090000)
       (td-write-u32 #x2000064 #x01000000)
       (td-write-u32 #x2000068 #x3F980000)))
    ...
    (setf (mem-ref #x200006C :u8) (if (>= arch 2) 63 255))
    ...
    (setf (mem-ref #x200006D :u8) (if (>= arch 2) 1 0))))

(defun e1000-state-base () (td-read-u32 #x2000040))
(defun e1000-rx-desc-base () (td-read-u32 #x200004C))
(defun e1000-rx-buf-base () (td-read-u32 #x2000050))
(defun e1000-tx-desc-base () (td-read-u32 #x2000054))
(defun e1000-tx-buf-base () (td-read-u32 #x2000058))
(defun ssh-conn-base () (td-read-u32 #x2000044))
(defun ssh-ipc-base () (td-read-u32 #x2000048))
(defun usb-ring-base () (td-read-u32 #x2000060))
(defun usb-dma-base () (td-read-u32 #x2000064))
(defun dwc2-base () (td-read-u32 #x2000068))
...
(defun buf-read-u32 (buf off)
  (let ((b0 (logand (aref buf off) (mem-ref #x200006C :u8))))
...
(defun buf-read-u32-mem (addr off)
  (let ((a0 (+ addr off)))
    (let ((b0 (logand (mem-ref a0 :u8) (mem-ref #x200006C :u8))))
  ...
  (let ((b0 (aref buf offset)))
    (let ((b1 (aref buf (+ offset 1))))
      (let ((b2 (aref buf (+ offset 2))))
        (let ((b3 (logand (aref buf (+ offset 3)) (mem-ref #x200006C :u8))))
          (flat-logior4 b0 (ash b1 8) (ash b2 16) (ash b3 24)))))))
(defun ssh-get-u32 (arr off)
  (let ((b0 (logand (aref arr off) (mem-ref #x200006C :u8))))
...
(defun htonl (v)
  (let ((b0 (logand v (mem-ref #x200006C :u8))))
